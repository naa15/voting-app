    ...
    <div class="ideas-container space-y-6 my-6">
                    ...
                    <div class="mt-8">
                        <button
                            class="w-20 bg-gray-200  border border-gray-200 hover:border-gray-400 font-bold
                                text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">
                            Vote
                        </button>
                    </div>
                </div>
        ...
        {{-- <div
            ...
            <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button
                        class="w-20 bg-blue border border-gray-200 hover:border-blue-hover font-bold text-white 
                        text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">
                        Voted
                    </button>
                </div>
