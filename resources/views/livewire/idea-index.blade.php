        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button
                    ...
                    class="w-20 bg-blue text-white border border-blue hover:border-blue-hover font-bold
        ...
        <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                <div x-data="{ isOpen: false }" class="flex items-center space-x-2 mt-4 md:mt-0">
                    <div class="{{ $idea->status->class }} text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">{{ $idea->status->name }}</div>
