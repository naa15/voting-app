...
>
    ...
    <ul x-show="isOpen" 
        ...
        class="absolute w-76 md:w-96 max-h-128 overflow-y-auto text-left bg-white shadow-dialog text-sm rounded-xl
        z-10 -right-28 md:-right-12"
    >
        @if ($notifications->isNotEmpty() && ! $isLoading)
            @foreach($notifications as $notification)
                <li><a 
                        ...
                        class="flex hover:bg-gray-100 transition duration-150
                            ease-in px-5 py-3">
                        <img src="{{ $notification->data['user_avatar'] }}" class="rounded-xl w-10 h-10"
                            alt="avatar">
                        <div class="ml-4">
                            <div>
            ...
            <li class="border-t border-gray-300 text-center">
                <button 
                    ...
                    @click=" isOpen = false "
                    href="#"
                    class="block w-full font-semibold hover:bg-gray-100 transition duration-150
                    ease-in px-5 py-4">
                    Mark all as read
                </button>
            </li>
