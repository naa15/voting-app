...
class EditIdeaTest extends TestCase
{
	...
	public function editing_an_idea_works_when_user_has_authorization()
	{
		...
		Livewire::actingAs($user)
			...
			->set('description', 'My edited description')
			->call('updateIdea')
	...
	/** @test*/
	public function editing_an_idea_shows_on_the_menu_when_user_has_authorization()
	{
		$user = User::factory()->create();
	...
	/** @test*/
	public function editing_an_idea_does_not_show_on_the_menu_when_user_has_no_authorization()
	{
		$user = User::factory()->create();
	...
	/** @test*/
	public function 
    editing_an_idea_does_not_work_when_user_has_no_authorization_because_different_user_created_idea()
	{
		$user = User::factory()->create();
	...
	/** @test*/
	public function 
    editing_an_idea_does_not_work_when_user_has_no_authorization_because_idea_was_created_longer_than_an_hour_ago()
	{
		$user = User::factory()->create();
