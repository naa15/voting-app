...
class ShowCommentsTest extends TestCase
{
	...
	/** @test*/
	public function idea_comments_liwevire_component_renders()
	{
	...
	/** @test*/
	public function idea_comment_liwevire_component_renders()
	{
		$idea = Idea::factory()->create();
	...
	/** @test*/
	public function op_badge_shows_if_author_of_idea_comments_on_the_idea()
	{
