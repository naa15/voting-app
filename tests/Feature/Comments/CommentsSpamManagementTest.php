...
class CommentsSpamManagementTest extends TestCase
{
	...
	/** @test*/
	public function marking_a_comment_as_spam_does_not_work_when_user_has_no_authorization()
	{
		$idea = Idea::factory()->create();
	...
	/** @test*/
	public function marking_an_idea_as_spam_shows_on_the_menu_when_user_has_authorization()
	{
		$user = User::factory()->create();
	...
	/** @test*/
	public function marking_an_idea_as_spam_does_not_show_on_the_menu_when_user_has_no_authorization()
	{
		$idea = Idea::factory()->create();
	...
	/** @test*/
	public function marking_a_comment_as_not_spam_does_not_work_when_user_has_no_authorization()
	{
		$user = User::factory()->create();
		$idea = Idea::factory()->create();
	...
	/** @test*/
	public function marking_a_comment_as_not_spam_shows_on_the_menu_when_user_has_authorization()
	{
		$user = User::factory()->admin()->create();
		$idea = Idea::factory()->create();
	...
	/** @test*/
	public function marking_a_comment_as_not_spam_does_not_show_on_the_menu_when_user_has_no_authorization()
	{
		$idea = Idea::factory()->create();
