...
class DeleteIdeaTest extends TestCase
{
	...
	/** @test*/
	public function deleting_an_idea_shows_on_the_menu_when_user_has_authorization()
	{
		$user = User::factory()->create();
	...
	/** @test*/
	public function deleting_an_idea_does_not_show_on_the_menu_when_user_has_no_authorization()
	{
		$user = User::factory()->create();
